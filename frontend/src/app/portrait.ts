...
@Component({
  ...
  template: `
    <div class="portrait" [class.portrait-card]="size() === 'card'" [class.portrait-avatar]="size() === 'avatar'" [class.portrait-detail]="size() === 'detail'">
      @if (!broken()) {
...
export class PortraitComponent {
  ...
  readonly size = input<'card' | 'avatar' | 'detail'>('card');
